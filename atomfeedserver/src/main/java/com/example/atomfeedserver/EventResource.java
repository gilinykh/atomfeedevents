...
public class EventResource {
    ...
    private static Logger logger = Logger.getLogger(org.ict4h.atomfeed.spring.resource.EventResource.class);
    ...
    @RequestMapping(method = RequestMethod.GET, value = "/feed/{feedNumber}", produces = "application/atom+xml")
    @ResponseBody
    ...
    @RequestMapping(method = RequestMethod.GET, value = "/feed/{category}/{feedNumber}", produces = "application/atom+xml")
    @ResponseBody
